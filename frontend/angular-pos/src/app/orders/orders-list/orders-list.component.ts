...
@Component({
          ...
          <div class="modal-body">
            ...
            <table class="pos-table" style="margin-bottom: 16px;">
              ...
              <tbody>
                <tr *ngFor="let item of selectedOrder.items" [class.item-row--voided]="item.voided">
                  ...
                  <td>
                    <span class="status-pill" [ngClass]="getItemKitchenStatusClass(item)">
            ...
            <div class="summary-box">
              ...
              <div class="summary-line total">
                ...
                <strong>{{ (selectedOrder.total || selectedOrder.paidAmount || selectedOrder.subtotal) | number:'1.0-0' }} so'm</strong>
              </div>
            ...
            <div class="receipt-paper" id="printable-receipt">
              ...
              <div class="receipt-totals">
                ...
                <div class="r-total-row final">
                  <span>JAMI:</span>
                  <span>{{ (selectedOrder.total || selectedOrder.paidAmount || selectedOrder.subtotal) | number:'1.0-0' }} so'm</span>
                </div>
  ...
  styles: [`
    ...
    .status-pill, .pos-badge {
      ...
      &.pill--cooking, &.pill--preparing, &.badge-kitchen {
        background: rgba(245, 158, 11, 0.15);
        color: #f59e0b;
        border: 1px solid rgba(245, 158, 11, 0.3);
      }

      &.pill--ready, &.badge-ready {
        background: rgba(16, 185, 129, 0.15);
        color: #10b981;
        border: 1px solid rgba(16, 185, 129, 0.3);
      }
      ...
      &.pill--cancelled, &.pill--voided, &.badge-cancelled {
...
export class OrdersListComponent implements OnInit {
  ...
  getItemKitchenStatusClass(item: any): string {
    ...
    switch (st) {
      ...
      case 'DELIVERED':
      case 'SERVED': return 'pill--served';
      default: return 'pill--new';
    }
  }
