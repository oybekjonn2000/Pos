 ...
 * ViewBox: 0 0 24 24 | stroke: currentColor | fill: none | stroke-width: 2 | round joins
 */
export const ICON_DEFINITIONS: Record<string, string> = {
  // Navigation & Core Business
  'dashboard': `<rect width="7" height="9" x="3" y="3" rx="1"/><rect width="7" height="5" x="14" y="3" rx="1"/><rect width="7" height="9" x="14" y="12" rx="1"/><rect width="7" height="5" x="3" y="16" rx="1"/>`,
  'building': `<path d="M6 22V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v18Z"/><path d="M6 12H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2"/><path d="M18 9h2a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2h-2"/><path d="M10 6h4"/><path d="M10 10h4"/><path d="M10 14h4"/><path d="M10 18h4"/>`,
  'restaurant': `<path d="M18 2v6a3 3 0 0 1-3 3 3 3 0 0 1-3-3V2"/><path d="M15 2v18"/><path d="M6 2v7a2 2 0 0 0 2 2 2 2 0 0 0 2-2V2"/><path d="M8 2v20"/>`,
  'tables': `<path d="M19 9V6a2 2 0 0 0-2-2H7a2 2 0 0 0-2 2v3"/><path d="M3 16a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-5a2 2 0 0 0-4 0v2H7v-2a2 2 0 0 0-4 0Z"/><path d="M5 18v2"/><path d="M19 18v2"/>`,
  ...
  'chef': `<path d="M6 13.8a4.5 4.5 0 0 1-.8-8.8A5 5 0 0 1 15 4a4.5 4.5 0 0 1 3.8 8.8"/><path d="M6 14v4a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2v-4"/><line x1="6" y1="17" x2="18" y2="17"/>`,
  ...
  'laptop': `<rect width="20" height="14" x="2" y="3" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/>`,
  ...
  'utensils': `<path d="M18 2v6a3 3 0 0 1-3 3 3 3 0 0 1-3-3V2"/><path d="M15 2v18"/><path d="M6 2v7a2 2 0 0 0 2 2 2 2 0 0 0 2-2V2"/><path d="M8 2v20"/>`,
  ...
  'file-text': `<path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><line x1="10" y1="9" x2="8" y2="9"/>`,
  'file-edit': `<path d="M4 13.5V4a2 2 0 0 1 2-2h8.5L20 7.5V20a2 2 0 0 1-2 2h-5.5"/><polyline points="14 2 14 8 20 8"/><path d="M10.4 12.6a2 2 0 1 1 3 3L6 23l-4 1 1-4Z"/>`,
  'excel': `<path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><polyline points="14 2 14 8 20 8"/><path d="M8 13h8"/><path d="M8 17h8"/><path d="M12 13v4"/>`,
  ...
  'pin': `<line x1="4" y1="9" x2="20" y2="9"/><line x1="4" y1="15" x2="20" y2="15"/><line x1="10" y1="3" x2="8" y2="21"/><line x1="16" y1="3" x2="14" y2="21"/>`,
  ...
  'hall': `<path d="M3 21h18"/><path d="M3 7v1h18V7"/><path d="M5 8v13"/><path d="M9 8v13"/><path d="M15 8v13"/><path d="M19 8v13"/><path d="M12 2 2 7h20L12 2Z"/>`,
...
/**
 * Maps common emojis found in legacy code to clean canonical icon names.
 */
...
export function resolveIconName(nameOrEmoji?: string): string {
  if (!nameOrEmoji) return 'dashboard';
  const trimmed = nameOrEmoji.trim();
  if (ICON_DEFINITIONS[trimmed]) return trimmed;
  if (EMOJI_TO_ICON_MAP[trimmed]) return EMOJI_TO_ICON_MAP[trimmed];
  const lower = trimmed.toLowerCase();
  if (ICON_DEFINITIONS[lower]) return lower;
  return 'dashboard';
}

export function getIconSvg(nameOrEmoji: string, options?: { size?: number | string; strokeWidth?: number; className?: string }): string {
  const iconName = resolveIconName(nameOrEmoji);
  const path = ICON_DEFINITIONS[iconName] || ICON_DEFINITIONS['dashboard'];
  const size = options?.size ?? 20;
  const sw = options?.strokeWidth ?? 2;
  const cls = options?.className ? `pos-icon ${options.className}` : 'pos-icon';

  return `<svg class="${cls}" width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${sw}" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${path}</svg>`;
}
...
export class AppIconComponent {
  ...
  @Input() strokeWidth = 2;
  @Input() color?: string;
  @Input('class') set classList(val: string) {
    this._class = val;
  }
  private _class = '';

  extraClass = computed(() => this._class);
